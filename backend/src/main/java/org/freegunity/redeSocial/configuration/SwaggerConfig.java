package org.freegunity.redeSocial.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.freegunity.redeSocial.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("FreegUnity").description("Projeto Integrador - Rede Social")
